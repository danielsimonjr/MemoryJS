...
| T62 | 3B.4–3B.7 (Procedural / Active Retrieval / Causal / World Model) — **plan drafted** [`2026-04-25-3b-memory-theory.md`](./2026-04-25-3b-memory-theory.md); ✅ 3B.4 Procedural Memory **SHIPPED** 2026-04-24 (`src/agent/procedural/`); ✅ 3B.6 Causal Reasoning **SHIPPED** 2026-04-24 (`src/agent/causal/`); 3B.5 (active retrieval) + 3B.7 (world model) remain no-deps | ROADMAP Phase 3B |
