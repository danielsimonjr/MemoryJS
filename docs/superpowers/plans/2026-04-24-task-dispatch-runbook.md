...
| T61 | η.6.x Enterprise (RBAC / Distributed / Security / Cloud / GPU) — **plan drafted** [`2026-04-25-eta-enterprise.md`](./2026-04-25-eta-enterprise.md); ✅ η.6.1 RBAC **SHIPPED** 2026-04-24 (`src/agent/rbac/`); η.6.2 (Redis), η.6.3 (zod/SQLCipher), η.6.4 (devops), η.6.5 (CUDA) gated | ROADMAP Phase 6 |
| T62 | 3B.4–3B.7 (Procedural / Active Retrieval / Causal / World Model) — **plan drafted** [`2026-04-25-3b-memory-theory.md`](./2026-04-25-3b-memory-theory.md); ✅ 3B.4 Procedural Memory + 3B.6 Causal Reasoning + 3B.7 World Model **SHIPPED** 2026-04-24 (`src/agent/procedural/`, `src/agent/causal/`, `src/agent/world/`); only 3B.5 (active retrieval) remains no-deps | ROADMAP Phase 3B |
