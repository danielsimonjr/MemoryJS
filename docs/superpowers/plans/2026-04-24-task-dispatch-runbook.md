...
| T60 | η.5.5 Collaboration Features — **plan drafted** [`2026-04-25-eta-collaboration.md`](./2026-04-25-eta-collaboration.md); ✅ ALL no-deps sub-features (5.5.a conflict view + 5.5.b visibility + 5.5.c OCC + 5.5.d audit attribution enforcer) **SHIPPED** 2026-04-24; only 5.5.e CRDT remains (gated on yjs peer dep approval) | ROADMAP Phase 5.5 |
| T61 | η.6.x Enterprise (RBAC / Distributed / Security / Cloud / GPU) — **plan drafted** [`2026-04-25-eta-enterprise.md`](./2026-04-25-eta-enterprise.md); ✅ η.6.1 RBAC **SHIPPED** 2026-04-24 (`src/agent/rbac/`); ✅ η.6.3 PiiRedactor sub-feature **SHIPPED** 2026-04-24 (`src/security/`); η.6.2 (Redis), η.6.3 InputValidator (zod), η.6.3 EncryptionAdapter (SQLCipher), η.6.4 (devops), η.6.5 (CUDA) gated | ROADMAP Phase 6 |
| T62 | 3B.4–3B.7 (Procedural / Active Retrieval / Causal / World Model) — **plan drafted** [`2026-04-25-3b-memory-theory.md`](./2026-04-25-3b-memory-theory.md); ✅ ALL FOUR sub-sections **SHIPPED** 2026-04-24 (3B.4 `src/agent/procedural/` + 3B.5 `src/agent/retrieval/` + 3B.6 `src/agent/causal/` + 3B.7 `src/agent/world/`) | ROADMAP Phase 3B |
