...
Phases 0–8 of the long-running `claude/recommend-improvements-5Jly9` branch — see `docs/planning/FUTURE_FEATURES_IMPLEMENTATION_PLAN.md`. All Phase 0–2 items + 9 of 12 Phase 3 items (step 35 closed in Phase 8; step 38 in Phase 7; steps 36 + 40 in Phase 6) + 4 of 7 Phase 4 items + 6 of 10 Phase 5 items + all 5 Phase 7 tasks + all 5 Phase 8 tasks. Remaining deferrals: Phase 3 steps 37/39/41 (Phases 9/10/11 — tiered index, LZ4, mmap), Phase 4 steps 42/43/45 (external deps), Phase 5 steps 55–58 (strategy / external deps). No SemVer-breaking changes.
