...
Phases 0–9 of the long-running `claude/recommend-improvements-5Jly9` branch — see `docs/planning/FUTURE_FEATURES_IMPLEMENTATION_PLAN.md`. All Phase 0–2 items + 10 of 12 Phase 3 items (step 41 closed in Phase 9; step 35 in Phase 8; step 38 in Phase 7; steps 36 + 40 in Phase 6) + 4 of 7 Phase 4 items + 6 of 10 Phase 5 items + all 5 Phase 7 tasks + all 5 Phase 8 tasks + all 6 Phase 9 tasks. Remaining deferrals: Phase 3 steps 37/39 (Phases 10/11 — LZ4, mmap), Phase 4 steps 42/43/45 (external deps), Phase 5 steps 55–58 (strategy / external deps). No SemVer-breaking changes.
